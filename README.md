...
Raw query results are cached to `metals_query_cache.pkl` after the first run so re-running the notebook doesn't re-hit the Materials Project API. Delete this file to force a fresh query (e.g. after ch[...] 
